...
class TransactionsPage {
   ...
   * */
  renderTitle(name){
    this.element.querySelector('.content-title').textContent = `${name.data.name}`;
  }
  ...
  formatDate(date){
    ...
    return `${data.getDate()} ${month[data.getMonth()]} ${data.getFullYear()} г. в ${data.toLocaleTimeString()}`;
  }
  ...
  renderTransactions(data){
    ...
    data.forEach(el => {
      this.element.querySelector(`.content`).insertAdjacentElement(`beforeend`, this.getTransactionHTML(el));
    });
  }
}